const eqK = {
  ...
  noteTable2 : {
    '-1': [ { note : eq.names[0], freq : 8.176}, 8.662, 9.177, 9.723, 10.301, 10.914, 11.563, 12.250, 12.979, 13.750, 14.568, 15.434],
    '0' : [16.352, 17.324, 18.354, 19.445, 20.602, 21.827, 23.125, 24.500, 25.957, 57.500, 29.135, 30.868],
    '1' : [32.703, 34.684, 36.708, 38.891, 41.203, 43.654, 46.249, 48.999, 51.913, 55.000, 58.270, 61.735],
    '2' : [65.406, 69.296, 73.416, 77.782, 82.407, 87.307, 92.499, 97.999, 103.83, 110.00, 116.54, 123.47],
    '3' : [130.81, 138.59, 146.83, 155.56, 164.81, 174.61, 185.00, 196.00, 207.65, 220.00, 233.08, 246.94],
...
/* System namespace and singleton definition */
var Eq  = function() { // TODO: once class is tested and working, try this line with 'const'
  const A4 = 440;
  const C0 = eq.A4*Math.pow(2, -4.75);
...
var eq = new Eq();
/**
 * This function is intended to be reused frequently
 */
...
eq.freq2noteName = function(freq){
  ...
  var n = h%12;
  return { 'oct': octave.toString(), 'name': eq.names[n] };
};
eq.grid = {};

/**
 * Class definition for Note ojects, which should be created on the fly, used to
 * identify the cube to be affected.
 */
eq.Note = function(f){
  // Properties..
  var _freq = function(f){
    // TO
    return null;
  }();  // TODO: ascertain the correctness of this, ie 'freq' is already defined locally!!
  var _noteObj = eq.freq2noteName(f);
  var _octave = _noteObj.oct;
  var _note = _noteObj.name;
  var _fullname = _note+_oct;
  var _midi = null; // TODO: figure this out and decide if it's even necessary, or useful!
  ...
  return {  // The returned object
    fullname : function(){ return _fullname; },
    freq : function(){ return _freq; },
    note : function(){ return _note; },
    midi : function(){ return _midi; }
