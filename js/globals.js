...
eq.Note = function(freq){
  var _freq = freq;  // TODO: ascertain the correctness of this, ie 'freq' is already defined locally!!
  var _note = eq.freq2noteName(freq);
  var _fullname = note.name+note.oct;
  var _midival = ; // TODO: figure this out and decide if it's even necessary, or useful!
